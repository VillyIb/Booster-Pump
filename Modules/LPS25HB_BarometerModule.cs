...
namespace Modules
{
    public class LPS25HB_BarometerModule : BaseModuleV2
    {
        ...
        private Register Settings0X10 => new Register(0X10, "RES_CONF", 1);
        ...
        private Register Settings0X20 => new Register(0x20, "Control Register", 1);
        ...
        private Register Reading0X28 => new Register(0x28, "Air Pressure & Temperature", 5);
